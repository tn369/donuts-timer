...
**どーなつタイマー 🍩** は、お子様の主体性を大切にしながら、目標に対して前向きに取り組めるよう支える視覚的なタイマーアプリケーションです。
お子様には「楽しい」「うれしい」「やってみたい」を、保護者の方には時間の見通しと前向きなコミュニケーションのきっかけを届けることを目指しています。

### プロダクトコンセプト

- **主体性を支える**: 自己決定理論の考え方をもとに、お子様が自ら目標を選んだり決めたりして進められる体験を大切にする。
- **親子で協力できる**: 保護者が一方的に管理するのではなく、いっしょに目標を決めて伴走できる設計を優先する。
- **小さな達成を積み重ねる**: 始めやすい、続けやすい、終わりやすい流れの中で「できた」を増やし、やりたくないタスクにも前向きに向き合えるようにする。

エージェントは、UI文言・機能提案・ドキュメント更新の際に、このコンセプトと矛盾しないかを必ず確認してください。

### 主な機能

- **ビジュアルタイマー**: 時間の経過をドーナツが欠けていくアニメーションで表現し、「進んでいる」を楽しく見える化する。
- **ごほうびモード**: タスクを早く終えると「あそぶ時間」が増え、「終わったらうれしいことがある」を共有しやすくする。
- **目標時刻モード**: 終了予定時刻から逆算して、現在の自由時間を算出し、無理なくゴールを示せるようにする。
- **きょうだいモード**: 二人同時の画面分割タイマーで、家族全体の進み方をそろえやすくする。
- **カスタマイズ**: タイマーの形状（星型、六角形など）や色の変更が可能で、お子様ごとの「やってみたい」を引き出しやすい。
- **保護者向けガイド**: コンセプト、主な機能、安心して使える点を確認できる。
